...
class ModelTrainer:
    ...
    def train_one_epoch(self):
        ...
        for idx, data in enumerate(self.train_loader):
            ...
            detection_outputs = self.model(error_ids, attention_masks, batch_splits)
    ...
    def evaluate_model(self):
        ...
        index_true_predict_correct = 0
        for index in indexs_true.detach().cpu().numpy():
            if predict_detections[index].item() == 1:
                index_true_predict_correct += 1
                
        total_label_1_correct = index_true_predict_correct
        # correction
